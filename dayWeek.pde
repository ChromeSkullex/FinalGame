...
void checkEnd(){
 ...
 if (week>2){
  ...
  textAlign(CENTER);
  fill(255);
  //i dont care im hard coding it 
  text("End of the Semester\nYour Final Grades\n"+classNames[0]+": "+returnGrade(classGrade[0])+" "+returnTotalTest(0)+"\n"+classNames[1]+": "+returnGrade(classGrade[1])+" "+returnTotalTest(1)+"\n"+classNames[2]+": "+returnGrade(classGrade[2])+" "+returnTotalTest(2)+"\nTotal GPA: " +returnGPA(), width/2,height*.4);
